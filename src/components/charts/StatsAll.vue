<template>
  <q-card flat class="card_border">
    <div class="text-center q-pa-sm">
      <b style="color: #017951"><q-icon name="grain" /> All Sales</b>
    </div>
    ...
    <div class="desktop_stats row q-pa-sm">
      ...
      <div class="q-pa-xs col-xs-12 col-sm-6 col-md-4">
        <q-card dark class="shadow-2 cash_grad card_border">
          <q-card-section class="text-center">
            ...
            <q-separator color="white" inset />
            <h6 class="q-ma-sm small_text">
              {{ account_store?.total_cash_sales }}
            </h6>
          </q-card-section>
        </q-card>
      </div>
      ...
      <div class="q-pa-xs col-xs-12 col-sm-6 col-md-4">
        <q-card dark class="shadow-2 mpesa_grad card_border">
          <q-card-section class="text-center">
            ...
            <q-separator color="white" inset />
            <h6 class="q-ma-sm small_text">
              {{ account_store?.total_mpesa_sales }}
            </h6>
          </q-card-section>
        </q-card>
      </div>
      ...
      <div class="q-pa-xs col-xs-12 col-sm-6 col-md-4">
        <q-card dark class="shadow-2 mpesa_cash_grad card_border">
          <q-card-section class="text-center">
            ...
            <q-separator color="white" inset />
            <h6 class="q-ma-sm small_text">
              {{ account_store?.total_mpesa_cash_sales }}
            </h6>
          </q-card-section>
        </q-card>
      </div>
      ...
      <div class="q-pa-xs col-xs-12 col-sm-6 col-md-4">
        <q-card dark class="shadow-2 debts_grad card_border">
          <q-card-section class="text-center">
            ...
            <q-separator color="white" inset />
            <h6 class="q-ma-sm small_text">
              {{ account_store?.total_debt_sales }}
            </h6>
          </q-card-section>
        </q-card>
      </div>
      ...
      <div class="q-pa-xs col-xs-12 col-sm-6 col-md-4">
        <q-card dark class="shadow-2 card_grad card_border">
          <q-card-section class="text-center">
            ...
            <q-separator color="white" inset />
            <h6 class="q-ma-sm small_text">
              {{ account_store?.total_card_sales }}
            </h6>
          </q-card-section>
        </q-card>
      </div>
      ...
      <div
        ...
        v-if="account_store?.total_pending_sales > 0"
      >
        <q-card dark class="shadow-2 pending_grad card_border">
          <q-card-section class="text-center">
            ...
            <q-separator color="white" inset />
            <h6 class="q-ma-sm small_text">
              {{ account_store?.total_pending_sales }}
            </h6>
          </q-card-section>
        </q-card>
      </div>
      ...
      >
        <q-card dark class="shadow-2 purchases_grad card_border">
          <q-card-section class="text-center">
            Purchases/Inventories <br />
            <q-btn size="xs" flat label="view more" to="/inventories" />
            <q-separator color="white" inset />
            <h6 class="q-ma-sm small_text">
              {{ account_store?.total_expense }}
            </h6>
          </q-card-section>
        </q-card>
      </div>
    ...
    <div class="mobile_stats q-pa-sm">
      <q-list>
        ...
        <q-item dark class="q-my-sm cash_grad card_border">
          ...
          <q-item-section side>
            <b>{{ account_store?.total_cash_sales }}</b>
          </q-item-section>
        </q-item>
        <q-item dark class="q-my-sm mpesa_grad card_border">
          ...
          <q-item-section side>
            <b>{{ account_store?.total_mpesa_sales }}</b>
          </q-item-section>
        </q-item>
        <q-item dark class="q-my-sm mpesa_cash_grad card_border">
          ...
          <q-item-section side>
            <b>{{ account_store?.total_mpesa_cash_sales }}</b>
          </q-item-section>
        </q-item>
        <q-item dark class="q-my-sm debts_grad card_border">
          ...
          <q-item-section side>
            <b>{{ account_store?.total_debt_sales }}</b>
          </q-item-section>
        </q-item>
        <q-item dark class="q-my-sm card_grad card_border">
          ...
          <q-item-section side>
            <b>{{ account_store?.total_card_sales }}</b>
          </q-item-section>
        </q-item>
        <q-item dark class="q-my-sm pending_grad card_border">
          ...
          <q-item-section side>
            <b>{{ account_store?.total_pending_sales }}</b>
          </q-item-section>
        </q-item>
        <q-item dark class="q-my-sm purchases_grad card_border">
          ...
          <q-item-section side>
            <b>{{ account_store?.total_expense }}</b>
          </q-item-section>
        </q-item>
      </q-list>
    </div>
